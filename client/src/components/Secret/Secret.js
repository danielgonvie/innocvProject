...
export default class Secret extends Component {
  ...
  render() {
        ...
        if (this.props.lang === true){
          ...
          text6= "What do you call a can opener that doesn't work? A can't opener!"
          text7= "You know what the loudest pet you can get is? A trumpet."
          text8= "Why did the scarecrow win an award? He was outstanding in his field."
    ...
    return (
      <div className="secret-panel">
        <h1>{text1}</h1>
        <p>{text2}{this.props.user.name}</p>
        <img
