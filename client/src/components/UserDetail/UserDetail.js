...
export default class UserDetail extends Component {
    constructor(props) {
      ...
      displayUser = () => {
        ...
        <input type="date" name="birthdate" pattern="20\d{2}(-|\/)((0[1-9])|(1[0-2]))(-|\/)((0[1-9])|([1-2][0-9])|(3[0-1]))(T|\s)(([0-1][0-9])|(2[0-3])):([0-5][0-9]):([0-5][0-9])" value={this.state.birthdate} onChange={e => this.handleChange(e)} className="user-edit-date" required></input>
