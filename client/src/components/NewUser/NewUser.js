        ...
        return (
            <div className="add-new-user-panel">
                ...
                <form className="add-user-form" onSubmit={e => this.pushUser(e, this.state.user.name, this.state.user.birthdate)} >
                 <input type="text" name="name" pattern="[A-Za-z_ áéíóú]{1,10}" value={this.state.user.name} onChange={e => this.handleChange(e)}  className="add-user-name" required placeholder="Name"></input>
